...
class OAVParams:
    ...
    def update_on_zoom(self, *args, zoom_level: Signal, **kwargs):
        print("Getting called!")
        self.zoom = zoom_level.get()
        print(self.zoom)
        self.load_microns_per_pixel(self.zoom)
        # beam position here too
    ...
    def load_microns_per_pixel(self, zoom: float):
        ...
        # return micronsPerXPixel, micronsPerYPixel

        # get the max tip distance in pixels
        # this part goes in context params
        # self.max_tip_distance_pixels = self.max_tip_distance / micronsPerXPixel
...
class OAV(AreaDetector):
    ...
    def __init__(self, *args, params: OAVParams, **kwargs):
        ...
        print("Trying to call update")
        self.zoom_controller.level.subscribe(self.parameters.update_on_zoom)

    # def _update_params_on_zoom(self, *args, zoom_level: Signal, **kwargs):
    #     zoom = zoom_level.get()
    #     self.parameters.update_on_zoom(zoom)
