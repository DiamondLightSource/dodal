...
class JungFrau1M(StandardReadable):
    def __init__(self, prefix: str, name: str = "") -> None:
        self.trigger_mode = epics_signal_rw(TriggerMode, prefix + "Timing")
        ...
        self.acquire_rbv = epics_signal_r(AcquireState, prefix + "Acquire_RBV")
        self.state_rbv = epics_signal_r(int, prefix + "State_RBV")
        self.writing_rbv = epics_signal_r(WriteState, prefix + "Writing_RBV")
        ...
        self.burst_mode = epics_signal_rw(BurstMode, prefix + "BurstMode")
