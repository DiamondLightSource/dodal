...
from dodal.devices.i09_1.enums import LensMode, PsuMode
...
class SpecsPhoibos225(
    ...
    def __init__(
        ...
        driver = I091SpecsAnalyserDriverIO(prefix)
        controller = I091ElectronAnalyserController(driver, energy_source, shutter)
