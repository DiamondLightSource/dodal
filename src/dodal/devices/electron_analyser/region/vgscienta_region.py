...
class VGScientaRegion(
    AbstractBaseRegion[VGScientaAcquisitionMode, TLensMode, TPassEnergyEnum],
    Generic[TLensMode, TPassEnergyEnum],
):
    # Override defaults of base region class
    lens_mode: TLensMode
    pass_energy: TPassEnergyEnum
    acquisition_mode: VGScientaAcquisitionMode = VGScientaAcquisitionMode.SWEPT
    ...
    detector_mode: VGScientaDetectorMode = VGScientaDetectorMode.ADC
