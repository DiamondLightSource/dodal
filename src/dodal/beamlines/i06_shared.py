...
def idd_controller(
    ...
    return I06Apple2Controller(
        ...
        hase_energy_motor_lut=i06_idd_epics_polynomial_device.energy_phase_motor_lookup,
...
def idu_controller(
    ...
    return I06Apple2Controller(
        ...
        hase_energy_motor_lut=i06_idu_epics_polynomial_device.energy_phase_motor_lookup,
