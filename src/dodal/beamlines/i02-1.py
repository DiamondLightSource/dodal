"""Beamline often also named VMXm"""
...
ZOOM_PARAMS_FILE = (
    "/dls_sw/i02-1/software/daq_configuration/xml/jCameraManZoomLevels.xml"
)
DISPLAY_CONFIG = "/dls_sw/i02-1/software/gda_versions/var/display.configuration"
DAQ_CONFIGURATION_PATH = "/dls_sw/i02-1/software/daq_configuration"

BL = get_beamline_name("test-i02-1")
set_log_beamline(BL)
set_utils_beamline(BL)
...
def attenuator(
    ...
    return device_instantiation(
        ...
        wait_for_connection,
        fake_with_ophyd_sim,
        bl_prefix=False,  # bl_prefix incorrectly gives BL02I instead of BL02J
    )


# Prefix currently gives BL02I instead of BL02J! The I happens insetead of J because class BeamlinePrefix assumes we use the first character of I02-1 for the suffix
