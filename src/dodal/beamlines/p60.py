...
from dodal.devices.p60 import LabXraySource, LabXraySourceReadable, LensMode, PsuMode
...
@device_factory()
def analyser_driver() -> VGScientaAnalyserDriverIO[LensMode, PsuMode]:
    energy_sources = {
        "source1": al_kalpha_source().energy_ev,
        "source2": mg_kalpha_source().energy_ev,
    }
    return VGScientaAnalyserDriverIO[LensMode, PsuMode](
