...
from tests.unit_tests.devices.test_daq_configuration import MOCK_DAQ_CONFIG_PATH
...
def fake_device_factory_beamline():
    import tests.unit_tests.fake_device_factory_beamline as beamline
...
def test_finds_device_factories() -> None:
    import tests.unit_tests.fake_beamline as fake_beamline

    factories = collect_factories(fake_beamline)

    from tests.unit_tests.fake_beamline import (
        device_a,
        device_b,
        device_c,
        generic_device_d,
...
def test_makes_devices_with_dependencies() -> None:
    import tests.unit_tests.fake_beamline_dependencies as fake_beamline
...
def test_makes_devices_with_disordered_dependencies() -> None:
    import tests.unit_tests.fake_beamline_disordered_dependencies as fake_beamline
...
def test_makes_devices_with_module_name() -> None:
    devices, exceptions = make_all_devices("tests.unit_tests.fake_beamline")
    assert {
        "readable",
        "motor",
        "cryo",
...
def test_no_signature_builtins_not_devices() -> None:
    import tests.unit_tests.fake_beamline_misbehaving_builtins as fake_beamline
...
def test_no_devices_when_all_factories_raise_exceptions() -> None:
    import tests.unit_tests.fake_beamline_all_devices_raise_exception as fake_beamline
...
def test_some_devices_when_some_factories_raise_exceptions() -> None:
    import tests.unit_tests.fake_beamline_some_devices_working as fake_beamline
...
def test_make_device_with_module_name():
    devices = make_device("tests.unit_tests.fake_beamline", "device_a")
...
def test_make_device_dependency_throws():
    import tests.unit_tests.fake_beamline_broken_dependency as fake_beamline
