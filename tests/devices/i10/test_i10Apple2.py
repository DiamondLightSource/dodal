...
async def mock_id_pgm(mock_id: I10Apple2, mock_pgm: PGM) -> EnergySetter:
    ...
    set_mock_value(mock_id_pgm.gap.low_limit_travel, -1999)
    set_mock_value(mock_id_pgm.gap.high_limit_travel, 1999)
    set_mock_value(mock_id_pgm.id.phase.btm_inner.velocity, 1)
    set_mock_value(mock_id_pgm.phase.btm_inner.low_limit_travel, -1999)
    set_mock_value(mock_id_pgm.phase.btm_inner.high_limit_travel, 1999)
    set_mock_value(mock_id_pgm.id.phase.top_inner.velocity, 1)
    set_mock_value(mock_id_pgm.phase.top_inner.low_limit_travel, -1999)
    set_mock_value(mock_id_pgm.phase.top_inner.high_limit_travel, 1999)
    set_mock_value(mock_id_pgm.id.phase.btm_outer.velocity, 1)
    set_mock_value(mock_id_pgm.phase.btm_outer.low_limit_travel, -1999)
    set_mock_value(mock_id_pgm.phase.btm_outer.high_limit_travel, 1999)
    set_mock_value(mock_id_pgm.id.phase.top_outer.velocity, 1)
    set_mock_value(mock_id_pgm.phase.top_outer.low_limit_travel, -1999)
    set_mock_value(mock_id_pgm.phase.top_outer.high_limit_travel, 1999)
