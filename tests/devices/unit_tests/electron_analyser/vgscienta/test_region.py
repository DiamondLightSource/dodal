...
def sequence() -> VGScientaSequence[LensMode, PsuMode, PassEnergy]:
    return load_json_file_to_class(
        VGScientaSequence[LensMode, PsuMode, PassEnergy], TEST_LEGACY_VGSCIENTA_SEQUENCE
    )


@pytest.fixture
def new_sequence() -> VGScientaSequence[LensMode, PsuMode, PassEnergy]:
    return load_json_file_to_class(
        VGScientaSequence[LensMode, PsuMode, PassEnergy], TEST_NEW_SCIENTA_SEQUENCE
    )
...
def test_new_file_loads_into_class_with_expected_values(
    new_sequence: VGScientaSequence[LensMode, PsuMode, PassEnergy],
    expected_region_values: list[dict[str, Any]],
) -> None:
