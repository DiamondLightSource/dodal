...
from dodal.devices.beamlines.i04.max_pixel import MaxPixel, convert_to_gray_and_blur
...
@patch("dodal.devices.beamlines.i04.max_pixel.convert_to_gray_and_blur")
