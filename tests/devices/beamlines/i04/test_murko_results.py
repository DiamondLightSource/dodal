...
@patch("dodal.devices.beamlines.i04.murko_results.calculate_beam_distance")
...
@patch("dodal.devices.beamlines.i04.murko_results.MurkoResultsDevice.process_result")
...
@patch("dodal.devices.beamlines.i04.murko_results.time.time")
