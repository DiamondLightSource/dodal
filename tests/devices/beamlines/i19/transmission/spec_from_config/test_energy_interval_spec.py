...
def test_that_energy_interval_spec_is_represented_as_expected_interval(
    energy_unit: str, lower_bound: float, upper_bound: float
) -> None:
    d: dict[str, Any] = {
        "units": energy_unit,
    ...
    energy_interval_spec: EnergyIntervalSpec = EnergyIntervalSpec(**d)
    interval = energy_interval_spec.as_interval
