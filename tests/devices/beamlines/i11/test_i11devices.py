...
from dodal.devices.beamlines.i11.cyberstar_blower import AutotunedCyberstarBlower
from dodal.devices.beamlines.i11.nx100robot import (
    NX100Robot,
    RobotJobs,
    RobotSampleState,
)
...
@patch("dodal.devices.beamlines.i11.nx100robot.LOGGER")
