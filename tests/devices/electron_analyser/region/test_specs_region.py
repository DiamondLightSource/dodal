...
from dodal.devices.electron_analyser.region import SpecsSequence
from dodal.devices.electron_analyser.region.specs_region import SpecsAcquisitionMode
...
def expected_region_values() -> list[dict[str, Any]]:
    return [
        {
            "name": "New_Region",
            "acquisition_mode": SpecsAcquisitionMode.FIXED_TRANSMISSION,
        ...
        {
            "name": "New_Region1",
            "acquisition_mode": SpecsAcquisitionMode.SNAPSHOT,
        ...
        {
            "name": "New_Region2",
            "acquisition_mode": SpecsAcquisitionMode.FIXED_ENERGY,
