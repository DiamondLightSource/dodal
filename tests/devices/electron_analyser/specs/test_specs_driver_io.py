...
@pytest.fixture
def sequence_loader() -> JsonSequenceLoader[SpecsSequence[LensMode, PsuMode]]:
    with init_devices(mock=True):
        sequence_loader = JsonSequenceLoader[SpecsSequence[LensMode, PsuMode]](
            SpecsSequence[LensMode, PsuMode]
        )
